...
const Websites = () => {
  return (
    <section id="achievement" className="">
      <div className="flex justify-between max-lg:flex-col gap-20 w-full max-container">
